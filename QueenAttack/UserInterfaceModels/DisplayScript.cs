...
namespace QueenAttack.UserInterfaceModels
{
	...
	class Display
	{
		...
		{
			ConsoleColor queenTalk = ConsoleColor.Yellow;
			TypeLine("After a couple days, the nameless chess piece has settled into their temporary dwelling.");
			TypeLine("It's... nice. No rigid schedule, no midnight emergency drills, no strick instructors.");
			...
			TypeLine("It happens not in the dead of night, but rather the blinding day.");
